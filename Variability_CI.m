...
%       MF      5-30        - 
%       LF      30-365      1-12
%       XF      > 1 yr      > 1 yr      saved as [12,1200] or [365,36500]
%       2to15   < 15        -
%       15to90  15-90       -
%       Full    all         all         saved as [0,1200] or [0 36500] by
%                                       convention
%
...
diary_filename = ['/home/kschwarzwald/CalcLogs/Variability_CI_out',num2str(startTimestamp(1)),num2str(startTimestamp(2)),num2str(startTimestamp(3)),num2str(startTimestamp(4))];
...
freq_bands = [0,5;5,30;30,365;365,Inf;0,Inf;0,15;15,90]; num_bands = size(freq_bands,1);
freq_band_names = {'< 5 days','5 - 30 days','30 - 365 days','> 1 year','all frequencies','2 - 15 days','15 - 90 days'};
freq_band_ID = {'HF','MF','LF','XF','Full','2t15','15t90'};
...
for var_idx = 1:length(VarIndices);
    ...
    for model_idx=1:length(modelArray);
        try
            ...
            filenameS = ['/project/moyer/Kevin/',model,'/',filevar,freq,model,'_',expArray{1},'_',expArray{2},'_',run{1},'StdDevCI',filename_add,'.mat'];
            ...
            if calc
                ...
                %Get filenames
                filename1 = strcat('/project/moyer/CMIP5_Raw/',model,'/',filevar,freq,model,'_',expArray{2},'_',run{2},num2str(strtyr{2}),'-',num2str(endyr{2}),'_DATA.mat');
                filename2 = strcat('/project/moyer/CMIP5_Raw/',model,'/',filevar,freq,model,'_',expArray{1},'_',run{1},num2str(strtyr{1}),'-',num2str(endyr{1}),'_DATA.mat');
                ...
                for experiment = 1:2
                    ...
                    %recalculating it
                    filename1SD = ['/project/moyer/Kevin/',model,'/',filevar,freq,model,'_',expArray{experiment},'_',run{1},num2str(strtyr{experiment}),'-',num2str(endyr{experiment}),'_sqrtPower.mat'];
    ...
    if save_log
        ...
        log_filename = ['/home/kschwarzwald/CalcLogs/Variability_CI_log',num2str(startTimestamp(1)),'-',num2str(startTimestamp(2)),'-',num2str(startTimestamp(3)),'-',num2str(startTimestamp(4)),'-',num2str(startTimestamp(5)),'-',num2str(startTimestamp(6)),'.txt'];
